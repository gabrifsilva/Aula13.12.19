...
<?php
  ...
  */
  ...
  $id[] = 1;
  $titulo[] = "1° Título";
  $texto[] = "Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.";
  $ativo[] = true;
  $img[] = "img/f1.jfif";
  ...
  ?>
      ...
      <div class="container marketing">
        ...
        ?>
                        <div class="col-lg-4">
                            <img class="rounded-circle" src="<?=$img[$i]?>" alt="Generic placeholder image" width="140" height="140">
                            <h2>Título</h2>
                            ...
                            <p><a class="btn btn-secondary" href="textos.php?id=<?=$id[$i]?>" role="button">Ver detalhes &raquo;</a></p>
                        </div>
    ...
    <script>window.jQuery || document.write('<script src="js/jquery-slim2.min.js"><\/script>')</script>
